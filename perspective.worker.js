...
module.exports = __webpack_require__.p + "eee043c2f41bc609.wasm";
...
value=new Date(value);value=value.toLocaleString([],type_config.format);}}formatter.setColumnValue(data,row,col_name,value);}}if(get_pkeys){const keys=slice.get_pkeys(ridx,0);formatter.initColumnRowPath(data,row,"__INDEX__");for(let i=0;i<keys.size();i++){// TODO: if __INDEX__ and set index have the same value,
